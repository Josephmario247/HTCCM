...
const Setting = () => {
  ...
  return (
    <div className='max-w-xl md:max-w-3xl mx-auto mt-10 bg-white p-8 rounded-md shadow-md w-96'>
        ...
        <form onSubmit={handleSubmit}>
                ...
                <button type='submit' className='w-full mt-6 bg-[#41436A] hover:bg-[#2a2b44] text-white font-bold py-2 px-4 rounded-md'> Change Password</button>
        </form>
